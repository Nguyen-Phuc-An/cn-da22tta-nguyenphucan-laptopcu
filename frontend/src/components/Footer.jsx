      ...
      <div style={{ width: '100%', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr 1fr', gap: '20px' }}>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            <li style={{ fontSize: '14px', marginBottom: '8px' }}>📍 1912 Quốc lộ 25 ấp A, xã B, tỉnh C</li>
            <li style={{ fontSize: '14px', marginBottom: '8px' }}>📞 0363 547 545</li>
            <li style={{ fontSize: '14px', marginBottom: '8px' }}>✉️ contact@laptopcu.com</li>
            <li style={{ fontSize: '14px', marginBottom: '8px' }}>⏰ Từ 7h - 19h</li>
          </ul>
        </div>
